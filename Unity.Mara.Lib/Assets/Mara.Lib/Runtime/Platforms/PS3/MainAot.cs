...
namespace Mara.Lib.Platforms.PS3
{
    public class MainAot : PatchProcess
    {
        ...
        public MainAot(string oriFolder, string outFolder, OWO filePath, string titleid, string[] RAPsfile, byte[] DEVKEY)
        ...
        public MainAot(string oriFolder, string outFolder, string filePath, string titleid, string[] RAPsfile,
            byte[] DEVKEY)
            : base(oriFolder, outFolder, filePath)
        {
            this.Titleid = titleid;
